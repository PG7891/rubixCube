#Code is adapted from https://github.com/Amber0914/Reinforcement_Learning_Algorithms/blob/master/Q-Learning/deep_frozenlake_unslippery.py
            ...
            for i in range(max_episodes):
                ...
                for j in range(max_actions):
                    action, pred_Q = sess.run([self.action, self.a2],
                                              feed_dict={self.a0: np.eye(self.in_units)[state:state + 1]})
